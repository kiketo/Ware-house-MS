    ...
    public class CreatePartnerCommand : ICommand
    {
        ...
        public async Task<string> Execute(IReadOnlyList<string> parameters)
        {
            ...
            try
            {
                ...
                {
                    case 1://name
                        partner = await this.partnerService.AddAsync(parameters[0]);
                    ...
                    case 2://name;VAT
                        ...
                        {
                            partner = await this.partnerService.AddAsync(parameters[0], vat: parameters[1]);
                    ...
                    case 3://name;town;adddress
                        ...
                        partner = await partnerService.AddAsync(parameters[0], address);
                    ...
                    case 4: //name;town;address;vat
                        ...
                        town = this.townService.GetTown(parameters[1]);
                        address = this.addressSevice.GetAddress(town, parameters[2]);
                        partner = await partnerService.AddAsync(parameters[0], address, parameters[3]);
